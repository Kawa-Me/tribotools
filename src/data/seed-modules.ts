...
export const seedModules: (Omit<Module, 'id' | 'icon' | 'lessons'> & { icon: string; lessons: Omit<Lesson, 'id'>[] })[] = [
  {
    ...
    lessons: [
      ...
      { title: 'Midjourney', type: 'text', content: 'Acesso via extensão.', imageUrl: 'https://placehold.co/400x533.png', accessUrl: 'https://www.midjourney.com', buttonText: 'Acessar Midjourney', accessEmail: 'user@example.com', accessPassword: 'password123', isActive: true },
    ],
  },
  {
    ...
    lessons: [
      ...
      { title: 'Grok A.I.', type: 'text', content: 'Acesso via extensão.', imageUrl: 'https://placehold.co/400x533.png', accessUrl: 'https://grok.x.ai', buttonText: 'Acessar Grok', accessEmail: 'user@example.com', accessPassword: 'password123', isActive: true },
      { title: 'HeyGen', type: 'text', content: 'Acesso via extensão.', imageUrl: 'https://placehold.co/400x533.png', accessUrl: 'https://www.heygen.com', buttonText: 'Acessar HeyGen', accessEmail: 'user@example.com', accessPassword: 'password123', isActive: true },
      { title: 'Gamma App', type: 'text', content: 'Acesso via extensão.', imageUrl: 'https://placehold.co/400x533.png', accessUrl: 'https://gamma.app', buttonText: 'Acessar Gamma', accessEmail: 'user@example.com', accessPassword: 'password123', isActive: true },
      ...
      { title: 'Perplexity', type: 'text', content: 'Acesso via extensão.', imageUrl: 'https://placehold.co/400x533.png', accessUrl: 'https://www.perplexity.ai', buttonText: 'Acessar Perplexity', accessEmail: 'user@example.com', accessPassword: 'password123', isActive: true },
      { title: 'Clicopy', type: 'text', content: 'Acesso via extensão.', imageUrl: 'https://placehold.co/400x533.png', accessUrl: '#', buttonText: 'Acessar Clicopy', accessEmail: 'user@example.com', accessPassword: 'password123', isActive: true },
    ],
  },
  {
  ...
  },
  {
    ...
    permission: 'ferramentas',
    lessons: [
      { title: 'DropKiller', type: 'text', content: 'Acesso via extensão.', imageUrl: 'https://placehold.co/400x533.png', accessUrl: '#', buttonText: 'Acessar DropKiller', accessEmail: 'user@example.com', accessPassword: 'password123', isActive: true },
